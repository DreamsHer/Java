			...
			<div class="panel-body">
				<form class="form-horizontal" id="formInsert" action="${ctx}/OuGuaHaoController/MenZhenGuaHao.do" method="post">					
					...
					<div class="form-group" style="margin-top:10px;">							
						...
						<label class="col-md-1 col-sm-1 control-label">年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;龄</label>															
						<div class="col-md-2 col-sm-1 reset">
					...
					<div class="form-group" style="margin-top:10px;">	
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别</label>															
						<div class="col-md-2 col-sm-1 reset">
						...
						<label class="col-md-1 col-sm-1 control-label">家庭地址</label>
						<div class="col-md-2 col-sm-1 reset">
					...
					<div class="form-group" style="margin-top:10px;">	
						...
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">工作单位</label>															
						<div class="col-md-2 col-sm-1">
							 <input type="text" class="form-control" name="" id="">	 						 	
						</div>
						<label class="col-md-1 col-sm-1 control-label">单位编码</label>															
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="regtime" id="regtime">									
						</div>							
					</div>
					<div class="form-group" style="margin-top:10px;">
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">身份证号</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="regtime" id="regtime">
						</div>
					...
					<div class="form-group" style="margin-top:10px;">	
						<input type="text" class="hidden" name="patientId" id="patientId" />						
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">是否社保</label>															
						<div class="col-md-2 col-sm-1">
							 <input type="text" class="form-control" name="" id="">	 						 	
						</div>
						<label class="col-md-1 col-sm-1 control-label">结算方式</label>															
						<div class="col-md-2 col-sm-1 reset">
					...
					<div class="form-group" style="margin-top:10px;">
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">主管医生</label>
						<div class="col-md-2 col-sm-1 reset">
						...
						<label class="col-md-1 col-sm-1 control-label">病房床位</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="registerno" id="registerno"/>								
						</div>
					</div>
					<div class="form-group" style="margin-top:10px;">
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">病情描述</label> 
						<div class="col-md-5 col-sm-1">
							<input type="text" class="form-control" name="regfee" id="regfee">
						</div>
					</div>
					...
					<div class="form-group" style="margin-top:10px;">						
						...
						<label class="col-md-1 col-sm-1 control-label">挂号编号</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="mzregno" id="mzregnoId">
						</div>						
					</div>
					<div class="form-group" style="margin-top:10px;">												
						...
						<label class="col-md-1 col-sm-1 control-label">登记人</label>
						<div class="col-md-2 col-sm-1 reset">
							<select name="jzbasedetailId" id="JiuZhenId" class="form-control">
								<option value="0">-- 选择登记人 --</option>
								<c:forEach items="${BasedetailListtt}" var="p">
									<option value="${p.basedetailId}">${p.basedetailname}</option>
								</c:forEach>
							</select>
					...
					<div class="form-group" style="margin-top:20px;">
						...
						<div class="col-sm-1">
							<button type="button" id="resetId" class="btn btn-primary btn-block btn-radius">
								<span class="glyphicon glyphicon-refresh"></span>&nbsp;取消</button>
						</div>
						<div class="col-sm-1">
