				...
				<form class="form-horizontal" id="formInsert" action="${ctx}/OuGuaHaoController/MenZhenGuaHao.do" method="post">					
					<div class="form-group" style="margin-top:40px;">	
						...
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="regtime" id="regtime" readonly>									
						</div>							
					</div>
					<div class="form-group" style="margin-top:30px;">	
						<input type="text" class="hidden" name="patientId" id="patientId" />						
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">预交金额</label>															
						<div class="col-md-2 col-sm-1">
							 <input type="text" class="form-control" name="mzregno" id="mzregnoId">	 						 	
						</div>
						<label class="col-md-1 col-sm-1 control-label">收费类型</label>															
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="regtime" id="regtime">									
						</div>							
					</div>
					<div class="form-group" style="margin-top:50px;">
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">基本情况</label>																	
					</div>				
					<div class="form-group" style="margin-top:30px;">							
						...
						<label class="col-md-1 col-sm-1 control-label">病人性别</label>															
						<div class="col-md-2 col-sm-1 reset">
					...
					<div class="form-group" style="margin-top:30px;">	
						...
						<label class="col-md-1 col-sm-1 control-label">所在科室</label>
						<div class="col-md-2 col-sm-1 reset">
					...
					<div class="form-group" style="margin-top:30px;">
						<label class="col-md-1 col-sm-1 col-sm-offset-3 control-label">已交金额</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="cardno" id="cardno"
								maxlength="16" onkeyup="value=value.replace(/[^0-9a-zA-Z]/g,'')">
						</div>
						<label class="col-md-1 col-sm-1 control-label">已用金额</label>
						<div class="col-md-2 col-sm-1 reset">
