	...
	<div class="container-fluid">
        <div class="panel panel-primary" style="width:100%;min-height:88%;">
             <div class="panel-heading">
                <h1 class="panel-title">接受库房药品和向库房退药</h1>
            </div>
			<div class="panel-body">
				<form class="form-horizontal" id="formInsert" action="" method="post">				
					<div class="form-group" style="margin-top:20px;">
						...
						<label class="col-md-1 col-sm-1 control-label reset">日期</label>															
						...
						<div class="col-sm-1">
							<button type="button" class="btn btn-primary btn-block btn-radius" id="btnInsert">查询</button>
						</div>	
						<div class="col-sm-1">
							<button type="button" class="btn btn-primary btn-block btn-radius" id="btnInsert">接受</button>
						</div>	
						<div class="col-sm-1">
						...
						<div class="col-sm-1">
							<button type="button" class="btn btn-primary btn-block btn-radius" id="btnInsert">退药</button>
						</div>	
						<div class="col-sm-1">
					...
					<div class="tab-pane" id="">
						<table id="JinKuTab" style="width:100%;">
							<tr>
								...
								<th w_index="username">出库单号</th>
								<th w_index="ordernumber">领料单号</th>
								<th w_index="sendname">进货价</th>
								<th w_render="bsgrdSendadrss">零售价</th>
								<th w_index="sendphonenumber">进货时间</th>
								<th w_index="takename">出库人</th>
								<th w_index="sendphonenumber">记录数</th>
							</tr>
						</table>
					</div>
										
					<div class="tab-pane" id="" style="margin-top:30px;">
						<table id="ChuKuTab" style="width:100%;">
							<tr>
								...
								<th w_index="ordernumber">规格型号</th>
								<th w_index="sendname">药品批号</th>
								<th w_render="bsgrdSendadrss">单位</th>
								<th w_index="sendphonenumber">数量</th>
								<th w_index="takename">进货价</th>
								<th w_index="sendphonenumber">零售价</th>
								<th w_index="takename">有效期</th>
							</tr>
						</table>
					</div> 
