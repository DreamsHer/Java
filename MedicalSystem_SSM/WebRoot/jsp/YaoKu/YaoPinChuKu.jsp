	...
	<div class="container-fluid">
        <div class="panel panel-primary" style="width:100%;min-height:88%;">
             <div class="panel-heading">
                <h1 class="panel-title">药品出库录入</h1>
            </div>
			<div class="panel-body">
				<form class="form-horizontal" id="formInsert" action="" method="post">
					...
					<div class="form-group" style="margin-top:20px;">
						...
						<label class="col-md-1 col-sm-1 control-label reset">散量零售价</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="itemmoney" id="itemmoney" >							
						</div>
						<label class="col-md-1 col-sm-1 control-label reset">零售价金额</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="itemmoney" id="itemmoney" >							
						</div>
					</div>
					...
					<div class="form-group" style="margin-top:20px;">
						...
						<label class="col-md-1 col-sm-1 control-label reset">整量零售价</label>
						<div class="col-md-2 col-sm-1 reset">
							<input type="text" class="form-control" name="itemmoney" id="itemmoney" >							
						</div>
						<label class="col-md-1 col-sm-1 control-label reset">零售价金额</label>
				...
				<div class="form-group" style="margin-top:10px;">
					...
					<div class="col-sm-1">
						<button type="button" class="btn btn-primary btn-block btn-radius"
							id="btnInsert">打印</button>
					</div>
					<div class="col-sm-1">
						<button type="button" class="btn btn-primary btn-block btn-radius"
							id="btnInsert">导出</button>
					</div>
					<div class="col-sm-1">
						<button type="button" class="btn btn-primary btn-block btn-radius"
							id="btnDingDanId">生成出库单</button>
					</div>
					<div class="col-sm-1">
						<button type="button" class="btn btn-primary btn-block btn-radius"
							id="btnInsert">退出</button>
					</div>
				</div>
